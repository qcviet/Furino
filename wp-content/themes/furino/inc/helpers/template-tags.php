...
function furino_get_svg_icon($name)
{
	...
	switch ($name):
		...
		case 'arrow-down':
			$value = '<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6l6 -6" /></svg>';
			break;
	endswitch;
	return $value;
}
